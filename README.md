...
No início da página principal, já é possível encontrar e descobrir detalhes sobre os últimos lançamentos de Hollywood. 
...
Clicando em cima de um poster, uma página contendo informações da obra correspondente sera exibida. Sendo elas:
...
- Elenco
- Trailer oficial
- Status, Lingua original, Produtora(s) e tagline
...
Na etapa anterior, foi ensinado a ver a aba de favoritos/listados, dessa vez escolha "meus dados".

Você pode:

- escolher um novo avatar entre os 6 disponiveis
- mudar a sua senha
...
- Autenticação segura com métodos diferentes
- Pesquisa de filmes, séries e pessoas 
- Informações sobre diversas obras cinematográficas
- Recomendação de filmes populares
- Visualização dos últimos lançamentos de Hollywood
- Recomendação personalizada baseada nas preferências de cada usuário
...
> [Acesse aqui](https://luizagsoaress.github.io/NextPick/)
