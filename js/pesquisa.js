...
async function inicializar() {
    ...
    for(let i = 0; i < filme.length; i++) {
        ...
        poster.style.border = '1px solid transparent';
        ...
        sinopse.style.display = '-webkit-box';
        sinopse.style.webkitLineClamp = '7';
